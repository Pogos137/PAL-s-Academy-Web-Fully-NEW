...
export default async function MessagesPage({
  ...
  // Admins get the academy-wide oversight inbox.
    ...
    >
      <div>
        ...
        <p className="mt-2 max-w-2xl text-sm text-ink-600">
          A private conversation for each of your classes. Reach your tutor directly — they and an
          academy admin will see your messages and reply right here.
        </p>

        <MessagesInbox threads={threads} currentUserId={user.id} initialActiveId={searchParams.c} />
      </div>
    </PortalShell>
  );
}
